...
def generate_page_recursive(basepath, dir_path_content:str, template_path: str, dest_dir_path: str) -> None:
    ...
    for md in content_root.rglob("index.md"):
        ...
        generate_page(basepath, str(md), template_path, str(dst))
...
def main():
    ...
    public_dir = os.path.join(here, '..', 'docs')
