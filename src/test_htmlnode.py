...
class TestHTMLNode(unittest.TestCase):
    ...
    def test_to_html_with_grandchildren_with_props(self):
        ...
        child_node = ParentNode("span", [grandchild_node])
        parent_node = ParentNode("div", [child_node], props={'href' : "https://www.google.com"})
        self.assertEqual(
            parent_node.to_html(),
            '<div href="https://www.google.com"><span><b href="https://www.google.com">grandchild</b></span></div>',
        )
